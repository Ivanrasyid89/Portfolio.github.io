...
| 3  | [**Jakarta Travel Time Prediction**](https://github.com/Ivanrasyid89/Portfolio.github.io/tree/main/Prediksi) | Python, Pandas, NumPy, Scikit-Learn, Matplotlib | Built a machine learning model to predict travel time between Jakarta districts using 11+ features. Performed data cleaning, feature engineering, encoding, and scaling. Compared Linear, Ridge, Lasso, ElasticNet, and SGD regression models. |
